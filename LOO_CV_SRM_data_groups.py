...
from Validation_class import prep_data_surrogate, surrogate_testing
...
base_path = "/Users/tristanhirs/Downloads/Thesis/Motor test data/Training_data_group/"  # Replace with the actual folder path
# Copy folders
train_folder = "/Users/tristanhirs/Downloads/Thesis/Motor test data/Train_data_del/"
validation_folder = "/Users/tristanhirs/Downloads/Thesis/Motor test data/Val_data_del/"
...
# Set folders and amount of groups




selected_folders = ['1', '2', '4', '6']
...
for i, (train_folders, validation_folders) in enumerate(splits):
    ...
    X_train, y_train, X_val_train, y_val_train = prep_data_surrogate(train_folder, scaled=True, n_outputs=2, n_samples=50, start_time=None, end_time=None).train_val_split(comb_data=True)
    ...
    for val_file in validation_files:
        ...
        # Obtain errors PINN
        _ , _, _, error_average_pinn, error_max_pinn, error_peak_pinn, execution_time_pinn = prep_data_surrogate(validation_folder, scaled=True, n_outputs=2, n_samples=1e12, start_time=None, end_time=None).compare_with_data(PINN_solid_rocket_motor_network.predict)
        ...
        # Obtain errors IPINN
        _ , _, _, error_average_ipinn, error_max_ipinn, error_peak_ipinn, execution_time_ipinn = prep_data_surrogate(validation_folder, scaled=True, n_outputs=2, n_samples=1e12, start_time=None, end_time=None).compare_with_data(IPINN_solid_rocket_motor_network.predict)
        ...
        # Obtain errors Data-driven
        _ , _, _, error_average_data_driven, error_max_data_driven, error_peak_data_driven, execution_time_data_driven = prep_data_surrogate(validation_folder, scaled=True, n_outputs=2, n_samples=1e12, start_time=None, end_time=None).compare_with_data(NN_solid_rocket_motor_network.predict)
        ...
        # Numerical method
        X_test , Experimental_data, _, _, _, _, _ = prep_data_surrogate(validation_folder, scaled=False, n_outputs=2, n_samples=1e12, start_time=None, end_time=None).compare_with_data()
...
if save_data == 1:
    ...
    output_csv_path = "/Users/tristanhirs/Downloads/Thesis/Motor test data/Error_file/surrogate_50_points_Number_grains_3_group_SRM.csv"  # Specify the path where you want to save the CSV
