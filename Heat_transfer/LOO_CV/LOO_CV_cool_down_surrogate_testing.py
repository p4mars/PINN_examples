...
# === USER INPUTS ===
base_path = "train_data"  # Replace with the actual folder path
# Copy folders
train_folder = "train_folder"
validation_folder = "validation_folder"
data_dir_error_file = 'error_folder'
...
if save_data == 1:
    ...
    output_csv_path = "output"  # Specify the path where you want to save the CSV
