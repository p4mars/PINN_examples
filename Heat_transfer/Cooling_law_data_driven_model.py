...
# Multiple file usage
data_dir = 'training_data'  # Path to CSV file(s)
data_dir_single = 'training_data'
#data_dir_trained_PINN = 'trained_pinn_model'
...
#torch.save(PINN.state_dict(), filt_data_filename)
