...
for test_file in move_datasets_for_loo_cv(data_dir, data_dir_val):
    ...
    X_train, y_train, X_val_train, y_val_train = prep_data_cooling_surrogate(data_dir, scaled=False, n_outputs=1, n_samples=50, start_time=None, end_time=None).train_val_split()
...
if save_data == 1:
    ...
    output_csv_path = "/Users/tristanhirs/Downloads/Thesis/Measurements_cup/Measurements/Error_file/no_points_cooling.csv"  # Specify the path where you want to save the CSV
