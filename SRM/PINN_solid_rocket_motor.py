...
PINN_solid_rocket_motor_network = NN(input_layer, output_layer, neurons_hidden, hidden_layers, epochs=5000, batch_size=64, use_batch=False, lr=1e-3, loss_terms=loss_functions, learn_params=None, unique_input=True, activation_fn=nn.ELU, init_method=nn.init.kaiming_uniform_)
...
#input_layer, output_layer, neurons_hidden, hidden_layers = 20, 2, 64, 4
#PINN_solid_rocket_motor_network = NN(input_layer, output_layer, neurons_hidden, hidden_layers, epochs=20000, batch_size=64, use_batch=False, lr=1e-3, loss_terms=None, learn_params=None, unique_input=True, activation_fn=nn.ELU, init_method=nn.init.kaiming_normal_)
