...
if save_data == 1:
    ...
    output_csv_path = "/Users/tristanhirs/Downloads/Thesis/Motor test data/Simulated_data/reference_test_2.csv"  # Specify the path where you want to save the CSV
    df.to_csv(output_csv_path, index=False)
else:
    pass
'''
